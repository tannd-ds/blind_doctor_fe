...
<template>
  <div class="flex items-center pt-0">
    ...
    >
      <button
          :class="[micStatus ? 'text-red-500 dark:text-red-500' : 'text-zinc-600 dark:text-zinc-200']"
      ...
      <input
          :disabled="micStatus"
          class="flex h-10 w-full rounded-md border-2 border-zinc-300 px-3 py-2 text-sm placeholder-[#6b7280] focus:outline-none focus:ring-2 focus:ring-[#9ca3af] disabled:cursor-not-allowed disabled:opacity-50 text-[#030712] focus-visible:ring-offset-2 dark:bg-zinc-900 dark:border-zinc-700 dark:text-zinc-200 dark:placeholder-[#9ca3af]"
          placeholder="Type your message"
          v-model="inputMessage"
      >

      <button type="submit" class="text-zinc-600 dark:text-zinc-200">
